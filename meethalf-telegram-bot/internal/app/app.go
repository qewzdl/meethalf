...
func New(cfg config.Config, logger *log.Logger) (*App, error) {
	...
	usecase := botusecase.New(sessionRepo, draftRepo, deleteConfirmRepo, adminActionRepo, ageConfirmRepo, profileClient, searchClient, adminClient, sender, cfg.Bot.AdminUsernames)
