...
var messageCatalog = map[domain.Language]map[messageKey]string{
	domain.LanguageEnglish: {
		...
		msgNamePromptNoTelegram:           "Your Telegram profile has no name yet. Type the name you'd like to use.",
		msgNamePromptWithTelegram:         "Telegram name: %s\nTap below to use it, or type a different one.",
		...
		msgNamePromptEmpty:                "Please enter a name to use.",
		msgNamePromptEmptyCreate:          "Please enter a name, or use your Telegram name below.",
		msgNamePromptTelegramMissing:      "Your Telegram profile has no name yet. Type the name you'd like to use.",
		...
		msgAgeConfirmPrompt:               "Please confirm you're at least %d years old to use the bot.",
	...
	domain.LanguageRussian: {
		...
		msgNamePromptNoTelegram:           "В профиле Telegram нет имени. Напишите, как вас показать.",
		msgNamePromptWithTelegram:         "Имя в Telegram: %s\nНажмите кнопку ниже, чтобы использовать его, или напишите другое.",
		...
		msgNamePromptEmpty:                "Введите имя, которое хотите использовать.",
		msgNamePromptEmptyCreate:          "Введите имя или воспользуйтесь кнопкой ниже, чтобы взять имя из Telegram.",
		msgNamePromptTelegramMissing:      "В профиле Telegram нет имени. Напишите, какое имя показать.",
		...
		msgAgeConfirmPrompt:               "Подтвердите, что вам не меньше %d лет, чтобы пользоваться ботом.",
