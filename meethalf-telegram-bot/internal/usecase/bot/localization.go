...
var messageCatalog = map[domain.Language]map[messageKey]string{
	domain.LanguageEnglish: {
		...
		msgAdminResetStartUsage:           "Send the user ID or @username to reset the 16+ confirmation.",
		msgAdminResetStartFailed:          "Unable to reset the 16+ confirmation. Please try again later.",
		msgAdminResetStartSuccess:         "16+ confirmation was reset for %s.",
		...
		msgLoadingAdminResetStart:         "Resetting 16+ confirmation...",
		...
		msgBirthDatePrompt:                "Enter your birth date in %s format (for example, %s).",
		...
		msgEditBirthDatePrompt:            "Enter the new birth date in %s format (for example, %s).",
		...
		msgBirthDateInvalid:               "Birth date must be in %s format (for example, %s). Try again.",
		msgAgeConfirmPrompt:               "Please confirm you are at least %d years old to use the bot.",
		msgAgeConfirmDeclined:             "Access is available only for users %d+. If you clicked by mistake, confirm your age below.",
		msgAgeConfirmSaveFailed:           "Failed to confirm your age. Please try again later.",
		msgAgeTooYoung:                    "Age must be at least %d.",
		msgAgeTooOld:                      "Age must be no more than %d years. Please check the birth date.",
		msgAgeAccessDenied:                "Access to the bot is available only for users aged %d and older.",
	...
	domain.LanguageRussian: {
		...
		msgAdminResetStartUsage:           "Отправьте ID пользователя или @username, чтобы сбросить подтверждение 16+.",
		msgAdminResetStartFailed:          "Не удалось сбросить подтверждение 16+. Попробуйте позже.",
		msgAdminResetStartSuccess:         "Подтверждение 16+ для %s сброшено.",
		...
		msgLoadingAdminResetStart:         "Сбрасываем подтверждение 16+...",
		...
		msgAgeConfirmPrompt:               "Подтвердите, что вам есть %d лет, чтобы пользоваться ботом.",
		msgAgeConfirmDeclined:             "Доступ только для пользователей от %d лет. Если ошибка — подтвердите возраст кнопкой ниже.",
		msgAgeConfirmSaveFailed:           "Не удалось подтвердить возраст. Попробуйте позже.",
		msgAgeTooYoung:                    "Возраст должен быть от %d лет. Проверьте дату рождения.",
		msgAgeTooOld:                      "Возраст должен быть до %d лет. Проверьте дату рождения.",
		msgAgeAccessDenied:                "Доступ к боту только для пользователей от %d лет.",
...
var buttonCatalog = map[domain.Language]map[buttonKey]string{
	domain.LanguageEnglish: {
		...
		btnAgeConfirmYes:          "I'm 16+",
		btnAgeConfirmNo:           "I'm under 16",
		...
		btnAdminResetStart:        "Reset 16+ confirmation",
	...
	domain.LanguageRussian: {
		...
		btnAgeConfirmYes:          "Мне есть 16",
		btnAgeConfirmNo:           "Мне нет 16",
		...
		btnAdminResetStart:        "Сбросить 16+ подтверждение",
